...
//uint16_t fft_local[ADC_BUFFER_SIZE/2];
...
void Waveform_Task(UArg arg0, UArg arg1) {
    ...
    //    }
//        else {
//            for(i = gADCBufferIndex; i < gADCBufferIndex+1024; i++) {
//                int index = ADC_BUFFER_WRAP(i);
//                fft_local[index] = gADCBuffer[index];
//            }
//        }
...
//            for(i = 0; i < 128; i++) {
//                scaledWave[i] = round(log10f(out[i].r));
//            }
       // }
        Semaphore_post(DisplaySem);
